...
exports.computeLink = exports.LinkProvider = void 0;
class LinkProvider {
    /**
    ...
    provideLinks(y, callback) {
        const links = exports.computeLink(y, this._regex, this._terminal, this._matchIndex).map((_link) => (Object.assign({ range: _link.range, text: _link.text, activate: this._handler }, this._options)));
        callback(links);
    }
}
...
exports.computeLink = computeLink;
