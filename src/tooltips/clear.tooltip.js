...
export const showClearToast = () => {
    notyf.open({
        ...
        message: `Type or click <button onclick="document.customDispatchEvent(new Event('${HELP_EVENT_NAME}'))"><strong>[help]</strong></button> to see the list of available commands. `,
    });
};
